...
Python wrapper for New Hampshire school enrollment data.

This is a thin rpy2 wrapper around the [nhschooldata](https://github.com/almartin82/nhschooldata) R package. It provides the same functionality but returns pandas DataFrames.

## Requirements

- Python 3.9+
- R 4.0+
- The `nhschooldata` R package installed
...
df_multi = nh.fetch_enr_multi([2020, 2021, 2022, 2023, 2024, 2025])
