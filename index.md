...
New Hampshire’s public schools enrolled 160,322 students in 2025-26 —
down 16% from 190,805 in 2011-12. This package provides 15 years of
enrollment data from the NH Department of Education, covering ~200
districts and ~500 schools.

Part of the [njschooldata](https://github.com/almartin82/njschooldata)
family.

**[Full documentation](https://almartin82.github.io/nhschooldata/)** —
...
![State enrollment
trend](https://almartin82.github.io/nhschooldata/articles/enrollment_hooks_files/figure-html/state-trend-chart-1.png)

State enrollment trend

[(source)](https://almartin82.github.io/nhschooldata/articles/enrollment_hooks.html#nh-lost-30000-students-since-2012)
...
![Charter school
growth](https://almartin82.github.io/nhschooldata/articles/enrollment_hooks_files/figure-html/charter-chart-1.png)

Charter school growth

[(source)](https://almartin82.github.io/nhschooldata/articles/enrollment_hooks.html#charter-schools-grew-from-06-to-39-of-enrollment)
...
![Year-over-year
change](https://almartin82.github.io/nhschooldata/articles/enrollment_hooks_files/figure-html/covid-chart-1.png)

Year-over-year change

[(source)](https://almartin82.github.io/nhschooldata/articles/enrollment_hooks.html#covid-erased-8259-students-in-a-single-year)

## Data Taxonomy

| Category           | Years     | Function                                                                                                                                                                          | Details                                                  |
|--------------------|-----------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------|
| **Enrollment**     | 2012-2026 | [`fetch_enr()`](https://almartin82.github.io/nhschooldata/reference/fetch_enr.md) / [`fetch_enr_multi()`](https://almartin82.github.io/nhschooldata/reference/fetch_enr_multi.md) | State, district, school. Grade-level totals              |
| Assessments        | —         | —                                                                                                                                                                                 | Not yet available                                        |
| Graduation         | —         | —                                                                                                                                                                                 | Not yet available                                        |
| **Directory**      | Current   | [`fetch_directory()`](https://almartin82.github.io/nhschooldata/reference/fetch_directory.md)                                                                                     | Schools, SAUs. Address, phone, principal, superintendent |
...
> taxonomy](https://almartin82.github.io/docs/DATA-CATEGORY-TAXONOMY.md)
...
— 15 stories covering state trends, district deep dives, grade-level
patterns, and structural analysis - [Function
reference](https://almartin82.github.io/nhschooldata/reference/)
...
![Manchester vs
Nashua](https://almartin82.github.io/nhschooldata/articles/enrollment_hooks_files/figure-html/manchester-nashua-chart-1.png)

Manchester vs Nashua

[(source)](https://almartin82.github.io/nhschooldata/articles/enrollment_hooks.html#manchester-lost-nearly-a-quarter-of-its-students)
...
![Smallest
districts](https://almartin82.github.io/nhschooldata/articles/enrollment_hooks_files/figure-html/smallest-chart-1.png)

Smallest districts

[(source)](https://almartin82.github.io/nhschooldata/articles/enrollment_hooks.html#errol-has-12-students-the-states-tiniest-district)
...
![Biggest
gainers](https://almartin82.github.io/nhschooldata/articles/enrollment_hooks_files/figure-html/gainers-chart-1.png)

Biggest gainers

[(source)](https://almartin82.github.io/nhschooldata/articles/enrollment_hooks.html#virtual-learning-academy-grew-756-the-biggest-gainer)
...
![Top losers
trend](https://almartin82.github.io/nhschooldata/articles/enrollment_hooks_files/figure-html/losers-chart-1.png)

Top losers trend

[(source)](https://almartin82.github.io/nhschooldata/articles/enrollment_hooks.html#top-5-losers-account-for-9481-lost-students)
...
![Pipeline
ratio](https://almartin82.github.io/nhschooldata/articles/enrollment_hooks_files/figure-html/pipeline-chart-1.png)

Pipeline ratio

[(source)](https://almartin82.github.io/nhschooldata/articles/enrollment_hooks.html#grade-12-consistently-outnumbers-grade-1)

### 9. PreK enrollment grew 39% while everything else shrank

PreK enrollment rose from 3,165 to 4,395 — a 39% increase — even as
overall enrollment fell 16%.
...
![PreK
trend](https://almartin82.github.io/nhschooldata/articles/enrollment_hooks_files/figure-html/prek-chart-1.png)

PreK trend

[(source)](https://almartin82.github.io/nhschooldata/articles/enrollment_hooks.html#prek-enrollment-grew-39-while-everything-else-shrank)
...
![Kindergarten
trend](https://almartin82.github.io/nhschooldata/articles/enrollment_hooks_files/figure-html/kindergarten-chart-1.png)

Kindergarten trend

[(source)](https://almartin82.github.io/nhschooldata/articles/enrollment_hooks.html#kindergarten-lost-1177-students-since-2012)
...
![School
counts](https://almartin82.github.io/nhschooldata/articles/enrollment_hooks_files/figure-html/school-counts-chart-1.png)

School counts

[(source)](https://almartin82.github.io/nhschooldata/articles/enrollment_hooks.html#one-school-districts-vs-manchesters-20)
...
![SAU
system](https://almartin82.github.io/nhschooldata/articles/enrollment_hooks_files/figure-html/sau-chart-1.png)

SAU system

[(source)](https://almartin82.github.io/nhschooldata/articles/enrollment_hooks.html#the-sau-system-one-administrator-multiple-districts)
...
![North
Country](https://almartin82.github.io/nhschooldata/articles/enrollment_hooks_files/figure-html/north-country-chart-1.png)

North Country

[(source)](https://almartin82.github.io/nhschooldata/articles/enrollment_hooks.html#north-country-lost-26-of-its-students)
...
![Regional
comparison](https://almartin82.github.io/nhschooldata/articles/enrollment_hooks_files/figure-html/southern-nh-chart-1.png)

Regional comparison

[(source)](https://almartin82.github.io/nhschooldata/articles/enrollment_hooks.html#southern-nhs-boston-corridor-also-losing-students)
...
![Grade
pyramid](https://almartin82.github.io/nhschooldata/articles/enrollment_hooks_files/figure-html/grade-pyramid-chart-1.png)

Grade pyramid

[(source)](https://almartin82.github.io/nhschooldata/articles/enrollment_hooks.html#the-grade-pyramid-where-nhs-students-are)
